...
async def get_media(request, client : httpx.AsyncClient, path_to_request, additional_headers = None, base_url = ""):
    async with client.stream("GET", f"{base_url}/{path_to_request}", headers=additional_headers) as tumblr_response:
